  ...
  return (
    <StyledSalesChart>
      ...
      <AreaChart data={data} height={300} width={700} >
        ...
        <YAxis units="$" tick={{fill: colors.text}} tickLine={{stroke: colors.text}} />
        <CartesianGrid strokeDasharray="4"  />
        <Tooltip contentStyle={{backgroundColor: colors.background}} />
        <Area dataKey="totalSales" type="monotone"
         stroke={colors.totalSales.stroke} strokeWidth={2} name="Total sales" unit="$" 
         fill={colors.totalSales.fill} />
        <Area dataKey="extrasSales" type="monotone" 
        stroke={colors.extrasSales.stroke} strokeWidth={2} name="Total sales" unit="$" 
